...
calculated numerically using MATLAB\@. The data will be transferred and analyzed there using the following equations as a basis\cite{SPAD}.


\begin{equation} \label{total-impulse}
...
\begin{table}
  ...
  \begin{tabularx}{\columnwidth}{@{}cXc@{}cXc@{}}
    ...
    \multicolumn{3}{ c }{\textbf{Propulsion System Part List}} \\ \toprule
...
Phil Lindin and T.J. Tarazevits for creating the PDD process and making it as easy as possible and for their continued help.
...
\begin{table}[ht]
  %\caption{Cold Gas Thruster Bill of Materials}
  \centering
