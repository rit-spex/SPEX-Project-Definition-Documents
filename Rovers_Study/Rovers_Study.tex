...
\begin{abstract}
  Design and construct a self driving rover. A rover would be an area of space exploration completely new to SPEX. The rover would be built with a mock mission in mind. It would employ a multidisciplinary team for construction and development. The rover would be extremely promotable and would look great at Imagine RIT. 
