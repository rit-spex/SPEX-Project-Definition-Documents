...
also need to be individuals proficient in electronic design, specifically with respect to printed circuit boards. Additionally,
individuals proficient in programming will be required for embedded systems design and ground-station interfaces. Finally,
