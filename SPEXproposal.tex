...
\author{
  ...
  Philip~Linden$^{*}$\thanks{$^{*}$BS/MEng '17, Mechanical Engineering},
  Austin~Bodzas$^{\dagger}$\thanks{$^{\dagger}$BS '19, Computer Science},
  ...
  %   Check here for more advanced options: http://tex.stackexchange.com/questions/826/symbols-instead-of-numbers-as-footnote-markers
}
